            ...
            <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-2">
                    ...
                    {(() => {
                        ...
                        // If invalid, try appending -01 for YYYY-MM format if it looks like one
                        if (isNaN(dateObj.getTime()) && /^\d{4}-\d{2}$/.test(selectedDate)) {
                            dateObj = new Date(selectedDate + '-01');
                        }

                        // If still invalid, fallback or show nothing
