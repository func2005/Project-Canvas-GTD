...
let ArchiveController = class ArchiveController {
    ...
    async getArchivedItems(page, limit, q) {
        return this.archiveService.getArchivedItems(page ? Number(page) : 1, limit ? Number(limit) : 20, q);
    }
};
...
], ArchiveController.prototype, "getArchivedItems", null);
