...
exports.DataItem = DataItem = __decorate([
    ...
    (0, typeorm_1.Index)(['user_id', 'updated_at']),
    (0, typeorm_1.Index)(['user_id', 'start_time', 'end_time'], { where: 'deleted = false' }),
    (0, typeorm_1.Index)(['user_id', 'system_status', 'do_date', 'sort_order'], { where: 'deleted = false' })
], DataItem);
